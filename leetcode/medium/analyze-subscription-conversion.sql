...
/*
Notes:
Hint: almost pure logic/math question; make sure that the average part includes a
distinct before the case statement to count only the distinct days the user has used the
plan. Filter out the people who didn't upgrade from the free plan by only keeping those
